...
private:
	...
	void connectInstructionsViaDataFlow(BjoernFunctionNode *func);
	// Dummy; just calls connectInstructionsViaDataFlow for instr
	void connectInstructionsViaDataFlow(BjoernBasicBlockNode *basicBlock);
	// Actually does something ;)
	void connectInstructionsViaDataFlow(BjoernInstructionNode *instr);
